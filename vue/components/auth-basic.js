                        ...
                        <div class="text-center mt-sm-2 mb-4 text-white-50">
                            <div>
                                <router-link to="/" class="d-inline-block auth-logo">
                                    <img src="/tmpl/images/logo-light.png" alt="" height="20">
                                </router-link>
                            </div>
							<!--
                            <p class="fs-15 fw-medium">CRM</p>
							-->
                        </div>
                    </div>
                </div>
                                ...
                                <div class="p-2 mt-4">
                                    <form @submit.prevent="postAuth">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input v-model="login" required type="text" class="form-control" id="username" placeholder="Enter username">
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="position-relative auth-pass-inputgroup mb-3">
                                                <input v-model="password" required  type="password" class="form-control pe-5 password-input" placeholder="Enter password" id="password-input">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0 text-muted">&copy; 2024</p>
                        </div>
                    </div>
                </div>
            </div>
